...
\markboth{Introdução}{}
\addcontentsline{toc}{chapter}{Introdução, \emph{por Marcos A.\,P. Ribeiro}}
...
Nordlinger. A tradução de \textit{Pr\ae terita} foi encetada e abandonada.}
...
\textls[-10]{Além disso, as digressões encadeadas e razoavelmente longas de Ruskin ---
...
Perdu}.
Todas as notas são da tradução, excetuando"-se as indicadas com \textsc{n.\,a.}, da autoria de Ruskin. }


 \begin{bibliohedra}
 \tit{Ford}, Madox Ford. \textit{O bom soldado}. São Paulo: Editora 34, 1997.

 \tit{Proust}, Marcel. \textit{A la recherce du temps perdu}. Paris: Éditions
 Robert Laffont, 1987.
