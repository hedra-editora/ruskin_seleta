...
impossível quanto Miranda.\footnote{Outra personagem de Shakespeare.} Mas Byron falou"-me, e reanimou"-as para mim, de
...
estilo do \textit{Childe Harold}.\footnote{\textit{Childe Harold's
  Pilgrimage} ou \textit{A Peregrinação de Childe Harold}, título de um
...
folhas de \textit{alchemilla}\footnote{Herbácea perene do gênero das Rosaceae,
