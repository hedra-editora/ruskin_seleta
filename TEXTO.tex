...
\end{verse}
\footnotetext{No original: ``\emph{For Scotland, my darling, lis full in thy view, /
...
\end{verse}
\footnotetext{``Deveria alguma próxima
  primavera / reviver as cinzas da urna?'' {[}\textsc{n.\,t.}{]}}
...
\end{verse}
\footnotetext{Switzer
  {[}no original{]}, evidentemente uma abreviação de Suíça
  {[}Switzerland, no original{]}. {[}\textsc{n.\,a.}{]}}
...
95. Assim, como disse, progredi nos estudos, para a alegria de Mr.\,Rowbotham, passando facilmente pelos três primeiros livros de Euclides,
...
\chapter{Capítulo \textsc{x}. Quem tu, Melpomene\footnote[*]{Início da Ode \textsc{iv} do poeta romano Quinto   Horácio Flaco (65--8 a.C.), em que ele agradece a Melpomene,
...
\end{verse}  
\footnotetext{``\emph{Onward, amid the copse `gang peep, / A narrow inlet, still and deep}''. {[}\textsc{n.\,t.}{]}}
