...
\chapter{As fontes de Wandel} %Capítulo \textsc{i}. 

\subsubsection{O leitor deve ser avisado que os dois primeiros capítulos são
reimpressões, com pequenas revisões, provenientes de \emph{Fors
Clavigera},\footnotemark{} tendo sido incluídos naquela obra
  primordialmente para ensinamento político, algo que agora me parece ter
  representado certa violência.}

\footnotetext{Obra de John Ruskin: \emph{Fors Clavigera.
...
\emph{Robson} \emph{Crusoé} e por \emph{O Peregrino}\footnote{\emph{The \label{peregrino}
...
%30. 
O ``\emph{dickey}'',\footnote{A palavra origina"-se de \emph{Dicky}, 
  apelido de \emph{Richard}. {[}\textsc{n.\,t.}{]}} --- (pensar que até este \label{dickey}
...
%32. 
O \emph{dickey} anteriormente mencionado, sendo indispensável que
...
existam dois (\emph{takeing} e
\emph{unintelligable}),\footnote{O correto seria \emph{taking} e
...
%70. 
Um correspondente equivocado queixou"-se, em \emph{Fors}, de meu rude
...
o \emph{Pilgrim's Progress}, a \emph{Holy War de Bunyan}, os
...
%94. 
Sob a tutoria, duas vezes por semana, à noite, de Mr.\,Rowbotham,
...
assento frontal externo para meu pai e Mary, um \emph{dickey},\footnote{Cf.
...
%129. 40\footnote{\emph{Cf}. Capítulo \textsc{iv}, 90. {[}\textsc{n.\,t.}{]}}
...
\emph{Forget"-me"-not},\footnote{Cf. Capítulo \textsc{v}, p.\,\pageref{102}. {[}\textsc{n.\,t.}{]}}
...
significado de Chillon\footnote{Refere"-se ao poema de Lord Byron, 
  \emph{The Prisoner of Chillon} (\emph{O Prisioneiro de
...
\emph{Fair Maid of Perth},\footnote{\emph{Formosa Donzela de
...
perfeições de Desdêmona\footnote{Personagem da peça \emph{Otelo, O Mouro
...
citas, imitando o \emph{Giaour}.\footnote{Cf. Capítulo \textsc{viii}, nota
