...
de se alcançar a hospedaria \texit{Three Kings} ao entardecer. Mas em
...
título de um famoso poema narrativo de Lord Byron.}\label{childe}} dos quais gostei muito àquela época; e,
...
esteve então Horace,\footnote{Quintus Horatius Flaccus (65--8 d.C.): poeta lírico romano durante o tempo do imperador Otávio
  ...
  Claudianus (fins do século 4--404 d.C.): poeta latino de origem
...
Betesda e Coríntios, figuradas nas séries sobre a Bíblia, que me
...
chamada de ``Faithful Abbeville'',\footnote{``Abbeville, a Fiel''.} contava com 40000 ``almas'', 
...
\textit{liberdade}. Em meio às grandes montanhas, não é sempre possível se
ir exatamente aonde se deseja, --- tudo em volta é longe demais, ou
