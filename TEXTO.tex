...
\footnotetext{Obra de John Ruskin: \textit{Fors Clavigera.
  ...
  entre 1871 e 1884. {[}\textsc{n.\,t.}{]}}

%1.
 Sou, e meu pai o fora antes de mim, um ferrenho Tory\footnote{Refere"-se
  ao \textit{Tory Party}: partido conservador britânico {[}\textsc{n.\,t.}{]}} da
...
levado ao inglês de Johnson\footnote{Samuel Johnson (1709--1784) foi escritor e lexicógrafo britânico {[}\textsc{n.\,t.}{]}} ou de Gibbon,\footnote{Edward Gibbon (1737--1794) foi historiador britânico, autor do clássico \textit{The History of the Decline and Fall of the Roman Empire} {[}\textsc{n.\,t.}{]}} como modelos de linguagem; mas, uma vez conhecendo o capítulo 32 do Deuteronômio, o Salmo 119, o capítulo 15 da 1ª Epístola aos Coríntios, o Sermão da Montanha, e a maioria do
...
duramente que qualquer outra. Tydides ou Idommeneus\footnote{Personagens
  da mitologia grega, citadas na \textit{Ilíada}, de Homero. {[}\textsc{n.\,t.}{]}} sempre matavam vinte troianos para cada um morto pelos outros,
...
\textit{Lady of the Lake},\footnote{Título de um longo poema de Sir Walter
  Scott. {[}\textsc{n.\,t.}{]}} de FitzJames,\footnote{James Fitzjames
...
Cavaleiro de Snowdoun.\footnote{Personagem de Sir Walter Scott, do poema
  narrativo \textit{Lady of the Lake}. {[}\textsc{n.\,t.}{]}} As galerias e
...
lhe pudesse pintar a cabeça do rei à maneira de Simone Memmi,\footnote{Pintor
  italiano, nascido em Siena no ano de 1283 e morto em Siena ou Avignon, em 1344 ou 1349. {[}\textsc{n.\,t.}{]}} como um emblema.
...
\end{verse}
\footnotetext{No original: \textit{For Scotland, my darling, lis full in thy view/\,With barefooted lassies, and mountains so blue}. {[}\textsc{n.\,t.}{]}}
...
O ``\textit{dickey}'',\footnote{A palavra origina"-se de \textit{Dicky}, 
  apelido de \textit{Richard}. {[}\textsc{n.\,t.}{]}} --- (pensar que até este \label{dickey}
...
minha. Ela foi uma de nossas ``muitas''\footnote{\textit{Many}, no
  ...
  pessoa agregada à família. {[}\textsc{n.\,t.}{]}} (as \textit{muitas} sendo quase
...
dos fundos, setenta jardas\footnote{Uma \textit{yard}, medida inglesa de
  comprimento, corresponde a 91,44 centímetros. {[}\textsc{n.\,t.}{]}} de comprimento
...
uma cabana,\footnote{\textit{Cottage}, no original. {[}\textsc{n.\,t.}{]}} um
...
\end{verse}
\footnotetext{No original: \textit{Shall any following spring revive\\
The ashes of the urn?} {[}\textsc{n.\,t.}{]}}
...
cinzas,\footnote{\textit{Ashes}, no original. {[}\textsc{n.\,t.}{]}} segundo seu
...
do primeiro Livro dos Reis e o 32º capítulo do Deuteronômio, que estão gastas,
...
\begin{tabular}{rl}
Êxodo       & Cap.\,15 e 20                                 \\
2 Samuel    & \quad"\hspace{1.5mm} 1, do 17º versículo até fim               \\
1 Reis      & \quad"\hspace{1.5mm} 8                                         \\
Salmos      & \quad"\hspace{1.5mm} 23, 32, 90, 91 103, 112, 119 e 139 \\
Provérbios  & \quad"\hspace{1.5mm} 2, 3, 8 e 12                           \\
Isaías      & \quad"\hspace{1.5mm} 58                                        \\
Mateus      & \quad"\hspace{1.5mm} 5, 6 e 7                                \\
Atos        & \quad"\hspace{1.5mm} 26                                        \\
1 Coríntios & \quad"\hspace{1.5mm} 13 e 15                                \\
Thiago & \quad"\hspace{1.5mm} 4                                         \\
Revelação   & \quad"\hspace{1.5mm} 5 e 6                                   
\end{tabular}
\end{table}
...
pés:\footnote{Um \textit{foot}, medida inglesa de comprimento, corresponde
  a 30,48 centímetros. {[}\textsc{n.\,t.}{]}} mas a crista aplana"-se rapidamente, em
...
\chapter{As margens do Tay} %Capítulo \textsc{iii}. 
...
\textsc{com pranchas de cobre}

\medskip

\textsc{impresso e composto por um garotinho}

\textsc{e também ilustrado}
...
\textit{unintelligable}),\footnote{O correto seria \textit{taking} e
  \textit{unintelligible}. {[}\textsc{n.\,t.}{]}} aos quais só posso atribuir
...
pai ter ido a City\footnote{Refere"-se à City of London, tradicional
  ...
  designado apenas como \textit{City}. {[}\textsc{n.\,t.}{]}} de carruagem e as
...
\textit{Deucalion}\footnote{Personagem da mitologia grega, filho de
  Prometeu e Pronoia. {[}\textsc{n.\,t.}{]}} e \textit{Proserpina},\footnote{Deus
...
\end{verse}
\footnotetext{\textit{Switzer} {[}no original{]}, evidentemente uma abreviação de Suíça
  {[}\textit{Switzerland}, no original{]}. {[}\textsc{n.\,a.}{]}}
...
\textit{Emblems} de Quarles,\footnote{Francis Quarles (1592--1644) foi um poeta
  ...
  \textit{Emblems}. {[}\textsc{n.\,t.}{]}} o \textit{Book of Martyrs} de
Foxe,\footnote{John Foxe (1516--1587) foi um escritor e religioso inglês {[}\textsc{n.\,t.}{]}} a \textit{Lady of Manor} de Mrs.\,Sherwood,\footnote{Mary Martha
  Sherwood (1775--1851) foi uma escritora inglesa de livros infantis {[}\textsc{n.\,t.}{]}} --- um livro terrível para mim, pelas histórias de garotas más
...
ou copiando as
ilustrações
de Cruikshank\footnote{Certamente George Cruikshank (1792--1878), caricaturista e ilustrador inglês. {[}\textsc{n.\,t.}{]}} para os contos de
...
``O presente de Henry Telford, Esq.'',\footnote{Abreviatura de
  ...
  empregado após o nome caso não haja outro predicado, como \textit{Mr}., \textit{Dr}. etc.
...
de Saussure,\footnote{Horace Bénédict Saussure (1740--1790), naturalista e
  ...
  fundador do alpinismo. {[}\textsc{n.\,t.}{]}} à página 201, e de ler as
...
%94. 
Sob a tutoria, duas vezes por semana, à noite, de Mr.\,Rowbotham (sempre convidado para um substancial chá conosco antes das lições, como
...
%95. 
Assim, como disse, progredi nos estudos, para a alegria de Mr.\,Rowbotham, passando facilmente pelos três primeiros livros de Euclides,
...
Croydon; morte pelo \textit{frio},\footnote{\textit{Cold}, no original; jogo de
  ...
  \textit{resfriado}. {[}\textsc{n.\,t.}{]}} literalmente, apanhada numa operação
doméstica de lavagem pelo vento do leste. Seu \textit{spaniel}\footnote{Raça
  ...
  caídas, cujo nome deriva de \textit{spanish}. {[}\textsc{n.\,t.}{]}} marrom e
...
Clifton. A história de Miss Edgeworth,\footnote{Maria Edgeworth
  (1767--1849), novelista anglo"-irlandesa. {[}\textsc{n.\,t.}{]}} \textit{Lazy
...
cr"-r"-a"-que\footnote{\textit{Gr"-r"-ish}, no original. Onomatopeia para o som
  ...
  inglesa \textit{grist}, que significa ``trigo a ser moído, trigo moído''.
...
nobreza\footnote{\textit{Gentry}, no original. {[}\textsc{n.\,t.}{]}} da cidade e
...
\textit{Pathfinder} de Cooper\footnote{James Fenimore Cooper (1789--1851):
  ...
  conhecida é \textit{O Último dos Moicanos}. {[}\textsc{n.\,t.}{]}} quase de
...
assento frontal externo para meu pai e Mary, um \textit{dickey},\footnote{Cf.
  Capítulo \textsc{i}, nota à página \pageref{dickey}. {[}\textsc{n.\,t.}{]}} maior do que o normal, para
...
brasão de armas, --- ``\textit{Vix ea nostra voco}'',\footnote{``Dificilmente
  chamo essas coisas de minhas.'' Ovidio, \textit{Metamorphoses}, 13.141.
...
%129. 40\footnote{\textit{Cf}. Capítulo \textsc{iv}, 90. {[}\textsc{n.\,t.}{]}}
...
franca, não à maneira de Agnes Wickfield,\footnote{Personagem do romance
  \textit{David Copperfield}, de Charles Dickens. {[}\textsc{n.\,t.}{]}} ``Eu o
...
combinação da vivacidade de Jin Vin\footnote{Personagem do livro
  \textit{The Fortune of Nigel}, de Sir Walter Scott. {[}\textsc{n.\,t.}{]}} com
...
descrita num trecho acima),\footnote{Cf. Capítulo \textsc{ii}, p.\,\pageref{herne}. {[}\textsc{n.\,t.}{]}} descendo seis ou sete portões, um belo gramado, sob a sombra
...
``\textit{navette}''.\footnote{\textit{Naïveté}: ingenuidade {[}\textsc{n.\,t.}{]}}
...
avanço nas quatro direções anteriormente descritas,\footnote{Cf.
  Capítulo \textsc{vi}, p.\,\pageref{139}. {[}\textsc{n.\,t.}{]}} perseguidas para meu próprio
...
\textit{Forget"-me"-not},\footnote{Cf. Capítulo \textsc{v}, p.\,\pageref{102}. {[}\textsc{n.\,t.}{]}}
...
Comet'', por Henry Neele, Esq.,\footnote{Cf. Capítulo \textsc{iii}, nota 4. %Não encontrei a nota
...
Rogers, meu \textit{Forget"-me"-not}, O \textit{Continental Annual},\footnote{\textit{Anuário
  Continental.} {[}\textsc{n.\,t.}{]}} e \textit{Friendship's
Offering}\footnote{\textit{Oferta de Amizade.} {[}\textsc{n.\,t.}{]}} como
...
\textit{Don Juan},\footnote{Longo poema satírico de Lord Byron. {[}\textsc{n.\,t.}{]}} --- \textit{a} partir do qual, percebendo meu interesse,
...
\textit{Transformed}\footnote{Obras de Lord Byron. {[}\textsc{n.\,t.}{]}} e
\textit{Vision of Judgment},\footnote{Obras de Lord Byron. {[}\textsc{n.\,t.}{]}}
...
eu me tornasse um Corsair\footnote{Personagem de um poema homônimo de
  Lord Byron. {[}\textsc{n.\,t.}{]}} ou um Giaour\footnote{Personagem de um \label{giaour}
...
interessam. Leia"-se, por acaso, esta passagem sobre Sheridan,\footnote{Certamente
  ...
  \textit{whig} irlandês. {[}\textsc{n.\,t.}{]}} em sua carta a Thomas
...
significam no dicionário. Desse modo, ``\textit{however}''\footnote{Como
  conjunção, significa ``porém'', ``contudo'', ``todavia''. {[}\textsc{n.\,t.}{]}} é usado em lugar de ``\textit{yet}''\footnote{Como conjunção,
...
porque significa ``\textit{howsoever''},\footnote{Advérbio, que significa
  ...
  teria derivado \textit{however}. {[}\textsc{n.\,t.}{]}} ou, integralmente,
``yet whatever they did''.\footnote{A despeito do que eles tenham feito.
  {[}\textsc{n.\,t.}{]}} ``\textit{Thick'' of society},\footnote{O turbilhão do
...
thousand''}\footnote{Dezenas, centenas, milhares. Ruskin refere"-se ao
  ...
  que o leitor perceba que se trata de uma multidão de anônimos. {[}\textsc{n.\,t.}{]}} ao invés de ``\textit{um milhão}'' ou ``mil milhares'', para
...
``\textit{unshadows''}\footnote{Desensombra. {[}\textsc{n.\,t.}{]}} --- diminui a
...
Lock},\footnote{\textit{O Rapto da Madeixa}: título de poema narrativo e
  satírico de Alexander Pope. {[}\textsc{n.\,t.}{]}} ou do \textit{Essay on}
...
Aquiles\footnote{Personagem da mitologia grega, Aquiles é um dos mais
  ...
  Anquises e Vênus, e herói da \textit{Eneida}, de Virgílio. {[}\textsc{n.\,t.}{]}} sobre Elias e São João: mas sem que meu coração duvidasse de
...
tentou me consolar pela morte de Jessie,\footnote{Cf. Episódio da
  morte de Jessie, Capítulo \textsc{iv}, p.\,\pageref{jessie}. {[}\textsc{n.\,t.}{]}} dizendo que ela
estava mais feliz no Paraíso; ou pela de Charles,\footnote{Cf.
  Episódio da morte de Charles, Capítulo \textsc{vi}, p.\,\pageref{157}. {[}\textsc{n.\,t.}{]}}
...
chamada de ``Faithful Abbeville'',\footnote{``Abbeville, a Fiel''. {[}\textsc{n.\,t.}{]}} contava com 40000 ``almas'', ``vivendo em grande harmonia
...
\chapter{Quem tu, Melpomene} %Capítulo \textsc{x}. 
%\footnote[*]{Início da Ode \textsc{iv} do poeta romano Quinto Horácio Flaco (65--8 a.C.), em que ele agradece a Melpomene, musa da tragédia na mitologia grega, o dom de ser um grande poeta lírico. {[}\textsc{n.\,t.}{]}}}
...
principal.\footnote{Cf. Capítulo \textsc{vii}, p.\,\pageref{153}. {[}\textsc{n.\,t.}{]}} Este
...
\textit{entrée}\footnote{Em francês, no original. {[}\textsc{n.\,t.}{]}} em bailes
...
jarreteira;\footnote{Relativo à Ordem da Jarreteira: ordem de cavalaria
  instituída na Inglaterra por Eduardo \textsc{iii}, no século \textsc{xiv}. {[}\textsc{n.\,t.}{]}}
...
\textit{I Puritani}\footnote{Ópera de Vincenzo Bellini. {[}\textsc{n.\,t.}{]}}
...
Taglioni;\footnote{Marie Taglioni (1804--1884): célebre bailarina sueca
  ...
  Sylphide} e \textit{La Fille du Danube}. {[}\textsc{n.\,t.}{]}} pessoa dotada
...
\textit{La Cidarem},\footnote{\textit{La ci darem la mano}, ária da ópera
  \textit{Don Giovanni}, de Mozart. {[}\textsc{n.\,t.}{]}} como se a plateia e
...
linhas do prelúdio de ``\textit{A te o cara}''\footnote{Ária da ópera
  \textit{I Puritani}, de Vincenzo Bellini. {[}\textsc{n.\,t.}{]}} e as
...
era permitido, sem objeções, continuar medindo o azul do céu\footnote{Cf.
  Capítulo \textsc{viii}, p.\,\pageref{176}. {[}\textsc{n.\,t.}{]}} e observando o movimento das
...
linha anterior a Pope, já pensava ter uma avaliação superior a de Mr.\,Dale. Sua citação de ``O rei Knut chegou num barco à vela''\footnote{``Knut
  ...
  \textit{Historia Eliensis}. {[}\textsc{n.\,t.}{]}} permaneceu comigo; e creio
...
Champs"-Elysées!\footnote{Cf. Capítulo \textsc{x}, p.\,\pageref{201}. {[}\textsc{n.\,t.}{]}}
...
me tornar um bandido; e ``Maiden Giuletta'',\footnote{Personagem de
  \textit{Leoni: a Legend of Italy}. {[}\textsc{n.\,t.}{]}} a quem atribuí todas
...
tranquilidade da Riva,\footnote{Provavelmente trata"-se de Riva degli
  Schiavoni, famosa \textit{promenade} à beira da água, em Veneza. {[}\textsc{n.\,t.}{]}} e das gôndolas --- cada uma como uma crescente turca
...
citas, imitando o \textit{Giaour}.\footnote{Cf. Capítulo \textsc{viii}, nota
à página \pageref{giaour}. {[}\textsc{n.\,t.}{]}}
...
perdi muito tempo com \textit{Sensitive Plant}\footnote{\textit{Planta
  ...
  {[}\textsc{n.\,t.}{]}} e \textit{Epipsychidion};\footnote{Título de um poema de
...
``\textit{prickly and pulpous and blistered and blue''};\footnote{``Espinhoso
  e polposo e bolhoso e azul''. {[}\textsc{n.\,t.}{]}} ou ``\textit{it was a
...
\chapter{O coro do Christ Curch} %Capítulo \textsc{xi}. 
...
Progress},\footnote{Cf. Capítulo \textsc{i}, nota à página \pageref{peregrino}. {[}\textsc{n.\,t.}{]}} não
...
sido enviado à masmorra de Chillon,\footnote{Cf. Capítulo \textsc{viii},
  nota à página \pageref{chillon}. {[}\textsc{n.\,t.}{]}} exceto pela umidade; melhor seria se
...
com seu \textit{collie},\footnote{Cão pastor escocês de pelo longo. {[}\textsc{n.\,t.}{]}} eu era eu mesmo, estava em meu lugar: mas, à mesa dos
...
algum breve texto em latim de Horácio, Juvenal,\footnote{Juvenal (Decimus
  ...
  de \textit{As Sátiras}. {[}\textsc{n.\,t.}{]}} ou qualquer outro escritor
...
conhecimento daquele grupo. Mas, para a pobre Clara,\footnote{Cf.
  Cap. \textsc{x}, p.\,\pageref{212}. {[}\textsc{n.\,t.}{]}} após seu primeiro baile, receber os
...
lesa"-majestade\footnote{Em francês no original: \textit{lèse"-majesté}.
  {[}\textsc{n.\,t.}{]}} contra a ordem dos estudantes"-\textit{gentlemen}:
...
\textit{Melancolia},\footnote{\textit{Melancolia}: obra de Albrecht Dürer.
...
Adèle,\footnote{Cf. Capítulo \textsc{x}, p.\,\pageref{207}. {[}\textsc{n.\,t.}{]}} algumas
...
seu quarto de professor, no quadrângulo do Tom,\footnote{Cf.
  Capítulo \textsc{xi}, nota à página \pageref{tom}. {[}\textsc{n.\,t.}{]}} começara a realizar, --- de
...
Argyllshire}''.\footnote{``Entre a Morada do Rei e Inveroran, Argyllshire''.
  {[}\textsc{n.\,t.}{]}} Para \textit{nós}, custou uma fortuna ---
...
Stanfield e Harding e Roberts\footnote{David Roberts (1796--1864): pintor
  ...
  {[}\textsc{n.\,t.}{]}} faziam o grande \textit{tour} pela Itália, Sicília,
...
justificar minha promoção da tutoria de Mr.\,Runciman\footnote{Cf.
  Cap. \textsc{iv}, p.\,\pageref{84}. {[}\textsc{n.\,t.}{]}} aos privilégios mais elevados da instrução
...
\hfill\textsc{argyll house}, \textit{13 de outubro de 1830}
...
a qual copiava as reproduções das vinhetas de Rogers,\footnote{Cf.
  Cap. \textsc{iv}, p.\,\pageref{87}. {[}\textsc{n.\,t.}{]}} sem me preocupar em saber onde se
...
como o Quilleboeuf, ou os ``Keelmen heaving in coals'',\footnote{Refere"-se
  ...
  \textit{Estivadores carregados de carvão ao luar}. {[}\textsc{n.\,t.}{]}}
...
\begin{quote}
\hfill\textsc{queen ann (\textit{sic}) street west, 47,}
...
percebo que nada em mim \textit{mudou}. Uma parte de mim morreu, mas
...
\end{verse}  
\footnotetext{No original: \textit{Onward, amid the copse gang peep,/\,A narrow inlet, still and deep}. {[}\textsc{n.\,t.}{]}}
...
\textit{Pintores} \textit{Modernos}) a percepção de um poder de julgamento,
...
deveriam conter, com nomes apropriados às circunstâncias,\footnote{\textit{Idler}
  = Ocioso, preguiçoso; \textit{Rambler} = Vagabundo, vadio. {[}\textsc{n.\,t.}{]}} mais alimento intelectual concentrados num reduzido volume do
...
Naturalmente, não havia qualquer motivo para que minha mãe \textit{me}
...
``digno de memória'', mas apenas de ``\textit{Guarda e Passa}''.\footnote{Célebre
  verso da \textit{Divina Comédia}, de Dante Alighieri. {[}\textsc{n.\,t.}{]}}
...
ser alegre nem total. O \textit{desejo} de obedecer já é desobediência; e,
embora nessa época eu realmente fizesse muitas coisas das quais não
gostava, para agradar meus pais, não tenho agora \textit{um} sentimento de
...
minha apresentação. Minha primeira preocupação era como servi"-\textit{las}
...
o francês de Paris, \textit{A Metafísica} de Kant e \textit{Os}
\textit{Princípios} de Newton; e então a levaram a Paris, e a esgotaram
...
harmonias de uma Miserere,\footnote{Refere"-se, provavelmente, à obra do
  ...
  \textit{Miserere, mei, Deus} (\textit{Tende Misericódia de mim, Deus}),
