...
e Redgaunlet\footnote{Personagem do romance homônimo de Sir Walter Scott
   traspassava mais salmões que qualquer dos pescadores
...
``O presente de Henry Telford, Esq.'',\footnote{Abreviatura de
  ...
  empregado após o nome caso não haja outro predicado, como \textit{Mr}., \textit{Dr}. etc.
   ainda mais curiosamente, não tenha colocado data:
...
cr"-r"-a"-que\footnote{\textit{Gr"-r"-ish}, no original. Onomatopeia para o som
  ...
  inglesa \textit{grist}, que significa ``trigo a ser moído, trigo moído''.
   e granular; e certo receio, que não chegava a aversão
...
brasão de armas, --- ``\textit{Vix ea nostra voco}'',\footnote{``Dificilmente
  chamo essas coisas de minhas.'' Ovidio, \textit{Metamorphoses}, 13.141.
   --- no que fui bem"-sucedido, acrescentando
...
Ghent e dos \textit{cortiles}\footnote{Em italiano no original.
  ...
  característico dos palácios do Renascimento italiano (século \textsc{xv}).
   recendendo a laranja de Gênova.
...
\textit{Forget"-me"-not},\footnote{Cf. Capítulo \textsc{v}, p.\,\pageref{102}. 
...
situação. Leram, então, alguns versos do \textit{Childe Harold},\footnote{\textit{Childe
  Harold' Pilgrimage}: título de um famoso poema narrativo de Lord Byron.
   dos quais gostei muito àquela época; e,
...
questão sido apresentada por James Forbes,\footnote{James David Forbes
  ...
  estudou geologicamente, tendo publicado livros sobre suas observações.
   mas de uma maneira mítica e com a desagradável
...
Dagoberto\footnote{Dagoberto \textsc{i} (602--639): rei merovíngio dos Francos.
   e, pouco antes da morte do príncipe, fundou o
...
perdi muito tempo com \textit{Sensitive Plant}\footnote{\textit{Planta
  Sensível}: título de um poema de Percy Byssche Shelley (1792--1822).
   e \textit{Epipsychidion};\footnote{Título de um poema de
...
\textit{Melancolia},\footnote{\textit{Melancolia}: obra de Albrecht Dürer.
   ou, até mesmo de um modo mais solene, dos Magníficos
...
em meus desenhos; um ou dois --- Scott Murray,\footnote{Provavelmente
  Charles Robert Scott Murray (1818--1882): aristocrata e político inglês
   por exemplo, e Lord Kildare --- eram tão assíduos
...
Argyllshire}''.\footnote{``Entre a Morada do Rei e Inveroran, Argyllshire''.
   Para \textit{nós}, custou uma fortuna ---
...
Stanfield e Harding e Roberts\footnote{David Roberts (1796--1864): pintor
  ...
  Conhecido pelas representações de paisagens do Egito e da Palestina.
   faziam o grande \textit{tour} pela Itália, Sicília,
...
justificar minha promoção da tutoria de Mr.\,Runciman\footnote{Cf.
  Cap. \textsc{iv}, p.\,\pageref{84}.  aos privilégios mais elevados da instrução
...
a qual copiava as reproduções das vinhetas de Rogers,\footnote{Cf.
  Cap. \textsc{iv}, p.\,\pageref{87}.  sem me preocupar em saber onde se
...
dos discípulos de Sir George Beaumont\footnote{Sir George Beaumont
  ...
  a primeira doação de pinturas recebida pela London National Gallery.
   diante dessas estranhas visões da natureza.
...
truly'',\footnote{Aproximadamente: ``Muito verdadeiramente seu amigo''.
   e para mim, ``Yours truly''.\footnote{Aproximadamente:
...
minha pobre e pequena Psychidion.\footnote{``Pequena alma'', em grego.
   E a reverência pela natureza e a paixão eram
...
deveriam conter, com nomes apropriados às circunstâncias,\footnote{\textit{Idler}
  = Ocioso, preguiçoso; \textit{Rambler} = Vagabundo, vadio.  mais alimento intelectual concentrados num reduzido volume do
...
Newdigate,\footnote{Refere"-se ao Newdigate Prize (Prêmio Newdigate),
  ...
  composição em versos. Instituído por Sir Roger Newdigate (1719--1806).
   --- expectativa de um homem de Primeira Classe. Ela
...
harmonias de uma Miserere,\footnote{Refere"-se, provavelmente, à obra do
  ...
  baseada nos Salmos 50 e 51.  --- e toda a força e
