...
de trabalho utilizados, perdôo"-me por recomendá"-los a outros escritores;
...
(O leitor deve ser avisado que os dois primeiros capítulos são
...
Clavigera}''\footnote{Obra de John Ruskin: \emph{Fors Clavigera.
  ...
  entre 1871 e 1884 {[}\textsc{n.\,t.}{]}.}, tendo sido incluídos naquela obra
primordialmente para ensinamento político, algo que agora me parece ter
representado certa violência.).

1. Sou, e meu pai o fora antes de mim, um ferrenho Tory\footnote{Refere"-se
...
2. Contei, entretanto, com ensinamentos ainda melhores que esses, aos
...
3. Dos meus mestres eleitos, Scott e Homero, aprendi, então, o Torismo,
...
tentam desobedecê"-los. Com Scott e Homero aprendi estranhas idéias sobre
...
Ultimamente, quer me parecer que a idéia de um rei tornou"-se exatamente
...
4. A tia que me dava carne de carneiro fria aos domingos era irmã de meu
...
5. Meu pai iniciou"-se no comércio de vinhos, sem capital, e com
...
de tubos que pareciam jibóias; e eu nunca me cansava de contemplar
...
6. Para grande regozijo de meu pai, à medida que eu crescia, ia
...
permitido querer --- a posse dessas coisas que se vêem em lojas de
...
significado do ato piedoso é que, como os filhos de Zebedeu\footnote{Personagem
  bíblico; pescador da Galiléia, pai de Tiago e João, discípulos de
...
insubordinação, a qual sempre estive tentada como criança, foi o
...
As massas concentradas de água; e o mar sobre a \qb{}praia, --\\
Então montanhas desmoronaram, e vales, antes \qb{}desconhecidos,\\
Permaneceram onde estavam. Muito diferente era \qb{}a Terra,\\
Quando o primeiro dilúvio veio, da segunda \qb{}Criação.\\
Agora veja o que produz! --- Rainha das flores, Ó \qb{}rosa,\\
De cujas pétalas de belas cores tais odores exala,\\
Deves agora ante teus súditos ser citada,\\
Tanto por tua beleza quanto por tua delicadeza \qb{}afamada.\\
Tua és a flor da Inglaterra, e a flor\\
Da Beleza --- da morada perfumada de Vênus.\\
E tu frequentemente espargirás doces perfumes a \qb{}tua volta,\\
E frequentemente te inclinarás, esconder"-te"-ás no \qb{}chão.\footnote{Um modo
...
Sobrelevará tua alegre corola por sobre as outras \qb{}flores,\\
...
prosa ---; de Shakespeare, Pope, Spenser\footnote{Edmund Spenser (1552/53--1599): poeta renascentista inglês, cuja obra mais conhecida é o
  ...
  Elizabeth I {[}\textsc{n.\,t.}{]}.}, Byron\footnote{Lord George Gordon Byron
...
não tinha idéia da modulação do refrão de uma balada e pouca paciência
...
para minha instrução, baladas como as de \emph{Bordo Helen}, \emph{The
...
``paraíso de trigo''\footnote{Salmo lxxviii, 24 {[}\textsc{n.\,a.}{]}.} como
...
quer da parte de meus pais, quer da parte de meu preceptor, a idéia de
...
um giro através do norte da Suíça, por Basiléia, Berna, Interlagos,
...
\emph{pence}\footnote{Plural de \emph{pino:} pede em português, moeda
...
Milton ou Byron; adequadamente, nenhum de nós atribuirmos muita
...
eram calculados para interessar o refinado menestrel de \textsc{stf} James Face;
...
factíveis. Eu já não gostava da idéia de crescer, --- nunca esperei ser
...
têm idéia das alegrias complexas, e das esperanças sinceras,
...
no dia seguinte, tentar alcançar Basiléia ou Schaffhausen, para nosso
descanso dominical.
...
Basiléia, deveria se admitir, não havia vista dos Alpes, não se ouvia
...
``\textsc{meu} \textsc{querido} \textsc{senhor}, --- Quando vejo a data da carta com a qual me
...
tranquilidade. A idéia do sucesso na escola ou na universidade, a mim
...
\emph{Forget"-me"-not}\footnote{\emph{Cf}. Capítulo V, 102 {[}\textsc{n.\,t.}{]}.},
...
(1817.) ``Com respeito à poesia em geral, estou convencido, quanto mais
...
(1818.) ``Pensei num prefácio defendendo Lord Hervey\footnote{Provavelmente
...
(A.) Conteúdo. Significa que a primeira coisa que se deve pensar sobre
...
(B.) Aprendizado. O lavrador de Ayrshire pode ter bons dotes, mas ele
não pode ser considerado como próximo a Homero, Dante ou Milton.

(C.) Efeito. Existe \emph{eficiência} em seus versos? Eles falam ao
...
(D.) Imaginação. Colocada num dos últimos lugares porque muitos
...
(E.) Paixão. Situada mais ainda para o fim da lista, porque todos os
bons homens e mulheres a possuem tanto quanto o poeta deveria ter.

(F.) Invenção. Colocada em último lugar, porque se pode ser um bom poeta
...
Creio que me lembro de apenas de um dia que começou com chuva.
...
\emph{La Cidarem}\footnote{\emph{La ci darem la mano}, ária da ópera
  \emph{Don Giovanni}, de Mozart {[}\textsc{n.\,t.}{]}.}, como se a platéia e
...
Champs"-Elysées!\footnote{\emph{Cf.} Capítulo X, 201 {[}\textsc{n.\,t.}{]}.}
...
idéia de meu casamento com uma católica romana era monstruosa demais
...
ficaria furioso com a simples idéia de eles usarem, na universidade, a
beca dos servis.
...
conhecimento daquele grupo. Mas, para a pobre Clara\footnote{\emph{Cf.}
  Cap X, 212 {[}\textsc{n.\,t.}{]}.}, após seu primeiro baile, receber os
...
Ele me falou sobre a planta da cidade de Tróia; um ou dois anos mais
...
Adèle\footnote{\emph{Cf,}. Capítulo X, 207 {[}\textsc{n.\,t.}{]}.}, algumas
...
\begin{quote}
``\textsc{caro} \textsc{senhor}, --- Recebi sua amável e reconfortante carta; embora
...
``\textsc{meu} \textsc{caro} \textsc{senhor}, --- Rogo que aceite meu agradecimento pelo seu zelo,
...
``P.S. --- Se o senhor deseja que seu manuscrito seja devolvido, tenha a
...
Um fio d'água, tranquilo e profundo.\footnote{``\emph{Onward, amid
  the copse `gang peep, / A narrow inlet, still and deep}'' {[}\textsc{n.\,t.}{]}.}
\end{verse}  
